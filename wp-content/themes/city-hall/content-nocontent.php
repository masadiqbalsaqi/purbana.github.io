<div class="wrapper-content-block">
	<div class="wrapper-content-align">
		...
		<div class="post-single">
			...
			<p><strong><?php esc_html_e( 'Thank you for installing City Hall Theme', 'city-hall' ); ?></strong></p>
			<p>You are now ready to start setting up your new website using our theme.
			<br>If you need help, please check out the <a href="https://www.academiathemes.com/documentation/city-hall/">City Hall Documentation Page</a> first.
			...
			<p>In short, here's what you need to do in order to have a website like <a href="http://demo.academiathemes.com/?theme=city-hall" target="_blank">our demo</a>.</p>
			...
			<p>City Hall Theme uses standard and custom widgets to quickly create your homepage.
