...
class academia_widget_featured_pages extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'widget_title' ); ?>" style="display: block; font-size: 14px; font-weight: bold; margin: 0 0 10px;"><?php esc_html_e('Widget Title', 'city-hall'); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'page1' ); ?>"><?php esc_html_e('Select page:', 'city-hall'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'page2' ); ?>" style="display: block; font-size: 14px; font-weight: bold; margin: 0 0 10px;"><?php esc_html_e('Select page:', 'city-hall'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'page3' ); ?>" style="display: block; font-size: 14px; font-weight: bold; margin: 0 0 10px;"><?php esc_html_e('Select page:', 'city-hall'); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_photo' ); ?>" style="font-size: 14px; font-weight: bold; margin: 0 0 10px;"><?php esc_html_e('Display Featured Image', 'city-hall'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_title' ); ?>" style="font-size: 14px; font-weight: bold; margin: 0 0 10px;"><?php esc_html_e('Display Title', 'city-hall'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_excerpt' ); ?>" style="font-size: 14px; font-weight: bold; margin: 0 0 10px;"><?php esc_html_e('Display Page Excerpt', 'city-hall'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_button' ); ?>" style="font-size: 14px; font-weight: bold; margin: 0 0 10px;"><?php esc_html_e('Display a Read More button', 'city-hall'); ?></label>
		</p>
